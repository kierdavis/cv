...
\begin{longtable}{L!{\sep}R}
  \rctline{Feb 2019--May 2019}{
    Developed a system-on-chip for use as a bicycle computer as part of a small team. My responsibilities involved writing the software for the system's embedded RISC-V processor, overseeing the digital logic synthesis and layout flow using Python and Linux shell scripting, and maintaining an automated test suite for the system.
  }

  \rctline{Oct 2018--May 2019}{
    Developed a system for interfacing a modern computer to a machine for producing punched paper tape, which will ultimately be used at the \nmoc{} to facilate use of their \replica{} of the historic \mbox{EDSAC} computer. This project is an opportunity to demonstrate my skills of system/electronic/software design and my abilities to communicate and meet schedules, as well as forming a major part of my degree course.
  }
