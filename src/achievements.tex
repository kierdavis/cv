...
\begin{longtable}{L!{\sep}R}
  \rctline{Aug 2017}{
    Volunteered to help organise the annual \summerschool{} at the university for the second year running, in which teams of 14--15 year olds complete a group engineering project with the aid of expert support and mentoring.
  }

  \rctline{Mar 2017}{
    Designed and constructed a quadcopter from scratch as part of a group design project. I led the development of the embedded electronics and control software, and exercised my organisational and technical skills in a very time-constrained environment.
  }
