...
\begin{longtable}{L!{\sep}R}
  ...
  \rctline{Oct 2016}{
    Developed the control logic for a simple stopwatch on an integrated circuit for a university group project. The design was then manufactured, following which testing was performed on the finished ICs. The extensive verification performed before the design was sent off resulted in the stopwatch controller working flawlessly.
  }
